...
const index = createInstance(defaults$1);

// Expose Axios class to allow class inheritance
index.Axios = Axios$2;

// Expose Cancel & CancelToken
index.CanceledError = CanceledError$1;
index.CancelToken = CancelToken$2;
index.isCancel = isCancel$1;
index.VERSION = VERSION$1;
index.toFormData = toFormData$1;

// Expose AxiosError class
index.AxiosError = AxiosError$1;

// alias for CanceledError for backward compatibility
index.Cancel = index.CanceledError;

// Expose all/spread
index.all = function all(promises) {
  return Promise.all(promises);
};

index.spread = spread$1;

// Expose isAxiosError
index.isAxiosError = isAxiosError$1;

// Expose mergeConfig
index.mergeConfig = mergeConfig$1;

index.AxiosHeaders = AxiosHeaders$2;

index.formToJSON = thing => formDataToJSON(utils$1.isHTMLForm(thing) ? new FormData(thing) : thing);

index.getAdapter = adapters.getAdapter;

index.HttpStatusCode = HttpStatusCode$2;
